...
def game_hang():
    ...
    import tkFont
    import ImageTk
    global bgLabel, endLabel, guessLabel
    #global b
    #global g
    root=Tk()
    master=Frame(root)
    ...
    bgImage=ImageTk.PhotoImage(file='Hang me\Backgrounds\\bg2.jpg')
    bgLabel=Label(master, image=bgImage)
    bgLabel.place(x=0,y=0)
    import sys
    import Image
    hangImage=['Hang me\Hangman\hangman1.png','Hang me\Hangman\hangman2.png','Hang me\Hangman\hangman3.png','Hang me\Hangman\hangman4.png','Hang me\Hangman\hangman5.png'\
               ,'Hang me\Hangman\hangman6.png','Hang me\Hangman\hangman7.png','Hang me\Hangman\hangman8.png','Hang me\Hangman\hangman9.png','Hang me\Hangman\hangman10.png','Hang me\Hangman\hangman11.png']
    WORDLIST_FILENAME = "Hang me\words.txt"
    ...
    def appendGuess(letter,sw):
        ...
        image=ImageTk.PhotoImage(file="Hang me\Backgrounds\\bg2.jpg")
    ...
    def NewGame():
        ...
        global bgImage
        global bgLabel
        bgImage=ImageTk.PhotoImage(file='Hang me\Backgrounds\\bg5.png')
        bgLabel=Label(master, image=bgImage)
        bgLabel.place(x=0,y=0)
        hangman(secretWord)
