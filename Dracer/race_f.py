...
x=[30,165,300]
c=1;
Cars=['CarsEdit\Blue.png','CarsEdit\Green.png','CarsEdit\Orange.png',\
...
car=load('CarsEdit\Red.png')
hourglass=load('Extras\HourEdit.png')
...
def infoPage():
    infoPage=load('StartPage\InfoPage.png')
    backB=load('StartPage\BackButton.png')
    while(True):
        MPOS=0,0
        s.fill(white)
